...
*   Copyright (C) 2012 by Glad Deschrijver <glad.deschrijver@gmail.com>
*
...
//    implicitHeight: Math.max(theme.defaultFont.mSize.height*1.6, Math.max(icon.height, label.paintedHeight) + surface.margins.top/2 + surface.margins.bottom/2)
    implicitHeight: Math.max(icon.height, label.paintedHeight) + surface.margins.top/2 + surface.margins.bottom/2
